...
wget https://raw.githubusercontent.com/Laksmana27/Tunneling/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/Laksmana27/Tunneling/main/udp/udp.sh && chmod +x udp.sh && ./udp.sh
clear
cat> /root/.profile << END
# ~/.profile: executed by Bourne-compatible login shells.
